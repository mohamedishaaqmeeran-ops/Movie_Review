        ...
        <div className="min-h-screen p-10">
            ...
            <div className="bg-white p-8 rounded-3xl mb-10">
                ...
                <p className="text-lg text-gray-700 text-center">
                    Welcome to the <span className="font-bold text-pink-600 italic">
                        Movie Review System
                    </span>.
                    This application allows users to explore movies,
                    view movie details and share reviews and ratings.
                </p>
            ...
            <div className="bg-white p-8 rounded-3xl text-center">
                ...
                <p className="text-lg text-gray-700 ">
                    ...
                    and
                    <span className="font-bold text-pink-600 italic"> MockAPI </span>.
                    It allows users to browse movies and share opinions
